...
export default function TopBar() {
  return (
    <header className="w-full bg-white dark:bg-gray-800 shadow-md border-b border-gray-200 dark:border-gray-700 px-4 md:px-6 py-3 md:py-4 flex items-center justify-between transition-colors duration-300">
      <div className="flex items-center gap-2 md:gap-4 min-w-0 flex-1">
        <h1 className="text-sm md:text-xl font-bold bg-gradient-to-r from-blue-600 to-blue-800 dark:from-blue-400 dark:to-blue-600 bg-clip-text text-transparent truncate">
          <span className="hidden sm:inline">STORM - Ocean Hazard Intelligence</span>
          <span className="sm:hidden">STORM Dashboard</span>
        </h1>
        <div className="hidden lg:flex items-center gap-2 px-3 py-1 bg-green-100 dark:bg-green-900 rounded-full">
